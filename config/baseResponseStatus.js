module.exports = {
    ...
    PETOK_EMPTY : { "isSuccess": false, "code": 2043, "message": "반려동물 반입 가능 여부를 입력해주세요. (1:가능, 0:불가)"},
    SMOKINGOK_EMPTY : { "isSuccess": false, "code": 2044, "message": "흡연 가능 여부를 입력해주세요 (1:가능, 0:불가)"},
    ...
    CANCELPOS_EMPTY : { "isSuccess": false, "code": 2049, "message": "예약취소 가능여부를 선택해주세요. (1:가능, 0:불가)"},
